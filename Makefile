...
NAME = push_swap
SRCS = main.c push_swap.c push.c swap.c rotate.c reverse_rotate.c error.c disorder_metric.c flags.c bench.c check_input.c simple_sort.c complex_sort.c medium_sort.c
OBJS = ${SRCS:.c=.o}
CC = cc
